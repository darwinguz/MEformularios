...
public class TCabecera  implements java.io.Serializable {
    ...
    public TCabecera(TLugarGeografico TLugarGeografico, String CNombreProyecto, String CAmie, String CZona, Date CFechaEntrega, Date CFechaInicio, Date CFechaElaboracionInforme, byte[] CFotoGeneral, byte[] CCroquis, Set TFichaDs) {
       this.TLugarGeografico = TLugarGeografico;
