...
public class ComponenteFicha implements ServicioFicha {
	...
	public void insertarFormulario(LinkedList<LinkedList<TdetalleFicha>> datosFicha) {
		...
		String query = "INSERT INTO t_ficha_ma (au_serial, c_serial, g_serial, fma_etiqueta, fma_cantidad_limite, fma_cantidad_ejecutada, fma_actualizacion_n, f_observacion_referencia) VALUES ('"
				+ "');";
