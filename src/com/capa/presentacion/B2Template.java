...
public class B2Template extends JFrame {
	 ...
	 * Create the frame.
	 */
	public B2Template(TFicha ficha) {
	...
	public void cargarPanelPestaña2(JPanel pnlPestaña2) {
		...
		panel_20.setLayout(new GridLayout(10, 0, 0, 0));
	...
	public void cargarPanelPestaña1(JPanel pnlPestaña1) {
		...
		JLabel lblLblbs_15 = new JLabel("<html><body><p align=right>Tubería de PVC 1/2\"  y L=3m</p></body></html>");
		...
		JLabel lblLblbs_16 = new JLabel("<html><body><p align=right>Tubería de PVC 1/2 \" y L=2.65m</p></body></html>");
		...
		JLabel lblLblbs_18 = new JLabel("<html><body><p align=right>Tubería de PVC 1\"  y L=3m</p></body></html>");
		...
		JLabel lblLblbs_20 = new JLabel(
				"<html><body><p align=right>Kit para conexión de tubería 1\". (lija pliego, polipega 1/4gal,2 uniones)</p></body></html>");
		...
		lblkitParaConexin.setFont(new Font("Arial", Font.PLAIN, 10));
		panel_40.add(lblkitParaConexin);
