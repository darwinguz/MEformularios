...
public class FichaATemplate {
	...
	public void generarDatos() {
		...
		try {
			...
			listaA.add(new TFichaA(gettCabecera().getCSerial(), FichaA.BS1.name(), FichaA.BS1.getDescripcion(),
					"UNIDAD", FichaA.BS1.getCantidadTotal(), ponderadoBS1, ejecutadoBS1, avanceBS1, ""));
			listaA.add(new TFichaA(gettCabecera().getCSerial(), FichaA.BS2.name(), FichaA.BS2.getDescripcion(),
					"UNIDAD", FichaA.BS2.getCantidadTotal(), ponderadoBS2, ejecutadoBS2, avanceBS2, ""));
			listaA.add(new TFichaA(gettCabecera().getCSerial(), FichaA.BS3.name(), FichaA.BS3.getDescripcion(),
					"UNIDAD", FichaA.BS3.getCantidadTotal(), ponderadoBS3, ejecutadoBS3, avanceBS3, ""));
			listaA.add(new TFichaA(gettCabecera().getCSerial(), FichaA.MEX.name(), FichaA.MEX.getDescripcion(),
					"UNIDAD", FichaA.MEX.getCantidadTotal(), ponderadoMEX, ejecutadoMEX, avanceMEX, ""));
			...
			JOptionPane.showMessageDialog(null, "No existen datos para generar Ficha A", "ERROR",
