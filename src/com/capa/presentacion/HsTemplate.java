...
import static com.capa.util.Constantes.LBL_HS_0;
import static com.capa.util.Constantes.LBL_HS_1;
import static com.capa.util.Constantes.LBL_HS_10;
import static com.capa.util.Constantes.LBL_HS_11;
import static com.capa.util.Constantes.LBL_HS_12;
import static com.capa.util.Constantes.LBL_HS_13;
import static com.capa.util.Constantes.LBL_HS_14;
import static com.capa.util.Constantes.LBL_HS_15;
import static com.capa.util.Constantes.LBL_HS_16;
import static com.capa.util.Constantes.LBL_HS_17;
import static com.capa.util.Constantes.LBL_HS_18;
import static com.capa.util.Constantes.LBL_HS_19;
import static com.capa.util.Constantes.LBL_HS_2;
import static com.capa.util.Constantes.LBL_HS_20;
import static com.capa.util.Constantes.LBL_HS_21;
import static com.capa.util.Constantes.LBL_HS_22;
import static com.capa.util.Constantes.LBL_HS_23;
import static com.capa.util.Constantes.LBL_HS_24;
import static com.capa.util.Constantes.LBL_HS_25;
import static com.capa.util.Constantes.LBL_HS_26;
import static com.capa.util.Constantes.LBL_HS_27;
import static com.capa.util.Constantes.LBL_HS_28;
import static com.capa.util.Constantes.LBL_HS_29;
import static com.capa.util.Constantes.LBL_HS_3;
import static com.capa.util.Constantes.LBL_HS_30;
import static com.capa.util.Constantes.LBL_HS_31;
import static com.capa.util.Constantes.LBL_HS_32;
import static com.capa.util.Constantes.LBL_HS_33;
import static com.capa.util.Constantes.LBL_HS_34;
import static com.capa.util.Constantes.LBL_HS_35;
import static com.capa.util.Constantes.LBL_HS_36;
import static com.capa.util.Constantes.LBL_HS_37;
import static com.capa.util.Constantes.LBL_HS_38;
import static com.capa.util.Constantes.LBL_HS_39;
import static com.capa.util.Constantes.LBL_HS_4;
import static com.capa.util.Constantes.LBL_HS_40;
import static com.capa.util.Constantes.LBL_HS_41;
import static com.capa.util.Constantes.LBL_HS_5;
import static com.capa.util.Constantes.LBL_HS_6;
import static com.capa.util.Constantes.LBL_HS_7;
import static com.capa.util.Constantes.LBL_HS_8;
import static com.capa.util.Constantes.LBL_HS_9;
import static com.capa.util.Constantes.TXT_HS_0;
import static com.capa.util.Constantes.TXT_HS_1;
import static com.capa.util.Constantes.TXT_HS_10;
import static com.capa.util.Constantes.TXT_HS_11;
import static com.capa.util.Constantes.TXT_HS_12;
import static com.capa.util.Constantes.TXT_HS_13;
import static com.capa.util.Constantes.TXT_HS_15;
import static com.capa.util.Constantes.TXT_HS_16;
import static com.capa.util.Constantes.TXT_HS_17;
import static com.capa.util.Constantes.TXT_HS_18;
import static com.capa.util.Constantes.TXT_HS_19;
import static com.capa.util.Constantes.TXT_HS_2;
import static com.capa.util.Constantes.TXT_HS_20;
import static com.capa.util.Constantes.TXT_HS_21;
import static com.capa.util.Constantes.TXT_HS_22;
import static com.capa.util.Constantes.TXT_HS_23;
import static com.capa.util.Constantes.TXT_HS_24;
import static com.capa.util.Constantes.TXT_HS_25;
import static com.capa.util.Constantes.TXT_HS_26;
import static com.capa.util.Constantes.TXT_HS_27;
import static com.capa.util.Constantes.TXT_HS_28;
import static com.capa.util.Constantes.TXT_HS_29;
import static com.capa.util.Constantes.TXT_HS_3;
import static com.capa.util.Constantes.TXT_HS_30;
import static com.capa.util.Constantes.TXT_HS_31;
import static com.capa.util.Constantes.TXT_HS_32;
import static com.capa.util.Constantes.TXT_HS_33;
import static com.capa.util.Constantes.TXT_HS_34;
import static com.capa.util.Constantes.TXT_HS_35;
import static com.capa.util.Constantes.TXT_HS_36;
import static com.capa.util.Constantes.TXT_HS_37;
import static com.capa.util.Constantes.TXT_HS_38;
import static com.capa.util.Constantes.TXT_HS_39;
import static com.capa.util.Constantes.TXT_HS_4;
import static com.capa.util.Constantes.TXT_HS_40;
import static com.capa.util.Constantes.TXT_HS_41;
import static com.capa.util.Constantes.TXT_HS_5;
import static com.capa.util.Constantes.TXT_HS_6;
import static com.capa.util.Constantes.TXT_HS_7;
...
public class HsTemplate extends JFrame {
	...
	private List<TdetalleFicha> getListaGrupos(TInformacionObligatoria infoObligatoria) {
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_1,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_2,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_3,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_4,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_5,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_6,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_7,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_8,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_9,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_10,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_11,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_12,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo1, ficha, LBL_HS_13,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_14,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_15,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_16,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_17,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_18,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_19,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_20,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_21,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_22,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_23,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_24,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_25,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_26,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo2, ficha, LBL_HS_27,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_28,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_29,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_30,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_31,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_32,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_33,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_34,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_35,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_36,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_37,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo3, ficha, LBL_HS_38,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo4, ficha, LBL_HS_39,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo4, ficha, LBL_HS_40,
		...
		detallesFicha.add(new TdetalleFicha(cabecera, infoObligatoria, grupo4, ficha, LBL_HS_41,
